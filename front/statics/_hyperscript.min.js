;(function (e, t) {
  ...
  class n {
    ...
    static tokenize(e, t) {
      ...
      while (o < a.length) {
        if (
          (q() === "-" && N() === "-" && (n.isWhitespace(I(2)) || I(2) === "" || I(2) === "-")) ||
          (q() === "/" && N() === "/" && (n.isWhitespace(I(2)) || I(2) === "" || I(2) === "/"))
        ) {
          h()
        } else if (
      ...
      function p(e, t) {
        return { type: e, value: t || "", start: o, end: o + 1, column: s, line: u }
      }
      function h() {
  ...
  class o {
    ...
    isArrayLike(e) {
      return (
        Array.isArray(e) ||
        (typeof NodeList !== "undefined" && (e instanceof NodeList || e instanceof HTMLCollection))
      )
    }
    isIterable(e) {
      return (
        typeof e === "object" && Symbol.iterator in e && typeof e[Symbol.iterator] === "function"
      )
    }
    shouldAutoIterate(e) {
    ...
    evaluateNoPromise(e, t) {
      ...
      if (r.next) {
        throw new Error(
          i.sourceFor.call(e) + " returned a Promise in a context that they are not allowed."
        )
      }
      return r
    }
    ...
    processNode(e) {
      ...
      if (e.querySelectorAll) {
        this.forEach(e.querySelectorAll(t + ", [type='text/hyperscript']"), (e) => {
          this.initElement(
            e,
            e instanceof HTMLScriptElement && e.type === "text/hyperscript" ? document.body : e
          )
        })
      }
    }
    ...
    beepValueToConsole(e, t, r) {
      if (this.triggerEvent(e, "hyperscript:beep", { element: e, expression: t, value: r })) {
        var n
        if (r) {
          if (r instanceof m) {
            n = "ElementCollection"
  ...
  function T(t) {
    ...
    function f(e, t, r) {
      if (t["contains"]) {
        ...
        throw Error(
          "The value of " + e.sourceFor() + " does not have a contains or includes method on it"
        )
      }
    }
    function p(e, t, r) {
      if (t["match"]) {
        ...
        throw Error(
          "The value of " + e.sourceFor() + " does not have a match or matches method on it"
        )
      }
    }
    ...
    t.addGrammarElement("jsBody", function (e, t, r) {
      ...
      var l = i.end + 1
      return { type: "jsBody", exposedFunctionNames: a, jsSource: r.source.substring(n, l) }
    })
  ...
  const S = Object.assign(b, {
    ...
    internals: { lexer: x, parser: g, runtime: k, Lexer: n, Tokens: i, Parser: a, Runtime: o },
    ElementCollection: m,
